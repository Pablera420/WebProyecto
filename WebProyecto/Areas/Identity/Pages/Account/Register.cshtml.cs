            ...
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        if (!await _roleManager.RoleExistsAsync(DS.Role_Auditor))
                        {
                            await _roleManager.CreateAsync(new IdentityRole(DS.Role_Auditor));
                        }
                    ...
                    //para validar que el usuario cumpla reglas de password
                    Input = new InputModel()
                    {
                        ListaRol =
                    _roleManager.Roles.Where(r => r.Name !=
